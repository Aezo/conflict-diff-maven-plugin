...
public class ConflictDiffMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            List<DependencyConflict> baseConflicts = collectTransitiveDependencyConflicts(baseBranch);
            ...
            List<DependencyConflict> currentConflicts = collectTransitiveDependencyConflicts(currentBranch);
    ...
    private List<DependencyConflict> collectTransitiveDependencyConflicts(String branchName)
            throws DependencyCollectionException, DependencyResolutionException, MojoExecutionException {
        debugLog("⏳ Collecting transitive dependency conflicts for branch: " + branchName);
        ...
        debugLog("Found " + dependencyConflicts.size() + " dependency conflicts for branch: " + branchName);
    ...
    private List<DependencyConflict> extractConflicts(DependencyNode rootNode) throws MojoExecutionException {
        ...
        debugLog("Found " + dependencyConflicts.size() + " artifacts with version conflicts");
        return dependencyConflicts;
    }
